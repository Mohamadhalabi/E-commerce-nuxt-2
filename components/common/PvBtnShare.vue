<template>
  <div class="social-icons mx-1">
    <div class=" d-flex mt-auto mb-auto space-between">
      <div class="mr-2" @click="shareOnFacebook" style="cursor: pointer">
      ...
      <div class="mr-2" @click="shareOnTwitter" style="cursor: pointer">
        <svg width="42" height="42" version="1.1" id="svg5" xmlns:svg="http://www.w3.org/2000/svg"
             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1668.56 1221.19"
             style="enable-background:new 0 0 1668.56 1221.19;margin-top: -5px" xml:space="preserve">
          <style type="text/css">.st0{stroke:#FFFFFF;stroke-miterlimit:10;}  .st1{fill:#FFFFFF;}</style><g><circle class="st0" cx="834.28" cy="610.6" r="481.33"/><g id="layer1" transform="translate(52.390088,-25.058597)"><path id="path1009" class="st1" d="M485.39,356.79l230.07,307.62L483.94,914.52h52.11l202.7-218.98l163.77,218.98h177.32L836.82,589.6l215.5-232.81h-52.11L813.54,558.46L662.71,356.79H485.39z M562.02,395.17h81.46l359.72,480.97h-81.46L562.02,395.17z"/></g></g>
        </svg>
      </div>
      <div class="mr-2" @click="shareOnWhatsApp" style="cursor: pointer">
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
      ...
      <div class="mr-2" @click="shareOnLinkedIn" style="cursor: pointer">
