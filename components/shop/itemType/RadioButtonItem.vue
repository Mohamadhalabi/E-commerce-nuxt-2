...
export default {
  ...
  methods: {
    ...
    changeBrand(slug){
       if (this.slugtype == "manufacturer"){
        if(this.$route.query['manufacturer-type'] !== undefined){
          this.$router.push(this.$route.path + '?manufacturer-type='+ this.$route.query['manufacturer-type'] + '&brands=' + slug)
        }
        else{
          this.$router.push(this.$route.path + '?brands=' + slug)
        }
      }
      else if (this.slugtype == "category")
      {
        if(this.$route.fullPath.includes('?'))
          this.$router.push(this.$route.fullPath+'&brands=' + slug)
        else
          this.$router.push(this.$route.fullPath+'?brands=' + slug)
      }
      else{
