<template>
  <main class="main">
    ...
    <div class="container">
      <h1 class="promotion additional-product-items mb-3">Xhorse Universal Flip Key Remote</h1>
      <div class="row">
        <div
...
export default {
  async asyncData({ params }) {
    const response = await Api.get(`/promotion/xhorse-universal-flip-key-remote`);
    return {
