<template>
  <main class="main">
    ...
    <div class="container">
      <h1 class="promotion additional-product-items mb-3">Genuine Mitsubishi Smart Key Remotes</h1>
      <div class="row">
        <div
...
export default {
  async asyncData({ params }) {
    const response = await Api.get(`/promotion/genuine-mitsubishi-smart-key-remotes`);
    return {
