  ...
  head() {
    return {
      ...
      link: [
        {
          rel: 'canonical',
          href: 'https://www.tlkeys.com/terms',
        },
      ],
      meta: [
        {
        ...
        {
          name: 'description',
          content: "Explore our concise terms for locksmith services. Trust Techno Lock Keys for security with integrity and professionalism."
        },
        {
          name: "og:type",
          content: "website",
